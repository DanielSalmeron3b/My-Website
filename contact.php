...
<section class="window window-contact">
    ...
    <article class="social-contact-window">
    <h2>DM me ;)</h2>
        <div class="social">
            <a data-text="Twitter" href="https://twitter.com/salmeron_dev" target="_blank" class="twitter">
            ...
            <a data-text="Instagram" href="https://instagram.com/salmeron.daniel_" target="_blank" class="instagram">
            ...
            <a data-text="LinkedIn" href="https://www.linkedin.com/in/salmeron-alvarado/" target="_blank" class="linkdin">
